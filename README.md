# ![](https://drive.google.com/uc?id=10INx5_pkhMcYRdx_OO4rXNXxcsvPtBYq) Bubble Sort 氣泡排序
...
這個過程中，每一輪都會使得未排序部分的最大元素浮到數列的右側。<br>
<br>
氣泡排序的時間複雜度是 O(n^2)，在處理大型數列時效率較低。<br>
因此，對於大型數據集，我們通常會選擇其他更高效的排序算法，<br>
如快速排序（Quick Sort）或合併排序（Merge Sort）。<br>
